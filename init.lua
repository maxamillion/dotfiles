  ...
  },
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        -- Toggles
        map('n', '<leader>gtb', gs.toggle_current_line_blame, { desc = '[g]it [t]oggle git [b]lame line' })
        map('n', '<leader>gtd', gs.toggle_deleted, { desc = '[g]it [t]oggle git show [d]deleted' })
      end,
    },
  },
  {
...
vim.keymap.set('n', '<leader>gg', ':LiveGrepGitRoot<cr>', { desc = '[f]ind by [G]rep on Git Root' })
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ignore_install = {},
    -- Additional Treesitter modules here:
    modules = {},
