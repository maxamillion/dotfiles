...
git_repos=(
    ...
    "${dev_dir}/tau git@github.com:maxamillion/tau.git https://github.com/huggingface/tau.git"
    ...
    "${dev_dir}/hummingbird-containers git@gitlab.com:maxamillion/hummingbird-containers.git https://gitlab.com/redhat/hummingbird/containers.git"
    "${dev_dir}/traust git@github.com:maxamillion/traust.git https://github.com/traust-security/traust"
    "${dev_dir}/traust-engine git@github.com:maxamillion/traust-engine.git https://github.com/traust-security/traust-engine"
    "${dev_dir}/traust-contracts git@github.com:maxamillion/traust-contracts.git https://github.com/traust-security/traust-contracts"
    "${dev_dir}/traust-ledger git@github.com:maxamillion/traust-ledger.git https://github.com/traust-security/traust-ledger"
    "${dev_dir}/traust-sdk git@github.com:maxamillion/traust-sdk.git https://github.com/traust-security/traust-sdk"
    ...
    "${dev_dir}/mcp-servers git@github.com:maxamillion/mcp-servers.git https://github.com/modelcontextprotocol/servers.git"
