...
git_repos=(
    ...
    "${dev_dir}/aap-containerized-installer git@gitlab.cee.redhat.com:admiller/aap-containerized-installer.git git@gitlab.cee.redhat.com:ansible/aap-containerized-installer.git"
